...
export const Button = styled.div`
    ...
    background-color: ${props => props.sky ? 'hsl(205,46%,92%)' : 'hsl(206,100%,52%)'};
    border-color: ${props => props.sky ? 'hsl(205,41%,63%)' : 'hsl(206,100%,52%)'};
    color: ${props => props.sky ? 'hsl(205,47%,42%)' : 'hsl(0,0%,100%)'};
    
    &:hover{
        background-color: ${props => props.sky ? 'hsl(205,57%,81%)' : 'hsl(206,100%,40%)'};
